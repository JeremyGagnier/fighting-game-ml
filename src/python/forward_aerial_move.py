...
class ForwardAerialMove:
	...
	def __init__(self, player):
		...
		self.player.lag = ForwardAerialMove.duration
...
def _make_hitbox(px,
	py,
	radius,
	damage = ForwardAerialMove.damage,
	hitlag = ForwardAerialMove.hitlag,
	knockback = ForwardAerialMove.knockback,
	knockback_angle = ForwardAerialMove.knockback_angle):
