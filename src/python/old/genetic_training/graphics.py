...
def _render_players(game_state):
    ...
    if game_state.p1_lag > 0:
        p1_color = (128, 0, 128)
    pygame.draw.rect(_screen, p1_color, (game_state.p1_x, game_state.p1_y - PLAYER_H / 2.0, PLAYER_W, PLAYER_H))

    p2_color = (255, 0, 0)
    if game_state.p2_lag > 0:
        p2_color = (128, 0, 128)
    pygame.draw.rect(_screen, p2_color, (game_state.p2_x, game_state.p2_y - PLAYER_H / 2.0, PLAYER_W, PLAYER_H))
"""
